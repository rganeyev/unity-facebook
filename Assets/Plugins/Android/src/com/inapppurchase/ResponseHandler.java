...
public class ResponseHandler {
    ...
    public static void purchaseResponse(
            ...
            final String orderId, final long purchaseTime, final String developerPayload, final String data, final String sign) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                synchronized (ResponseHandler.class) {
                    if (sPurchaseObserver != null) {
                        if (Consts.DEBUG)
                            Log.e(TAG, "sPurchaseObserver");
                        sPurchaseObserver.postPurchaseStateChange(
                                purchaseState, productId, purchaseTime, developerPayload, data, sign);
                    } else if (Consts.DEBUG)
                        Log.e(TAG, "sPurchaseObserver is null");
                }
            }
        }).start();
    }
