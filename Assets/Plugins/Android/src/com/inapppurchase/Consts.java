...
public class Consts {
    ...
    public enum ResponseCode {
        ...
        public static int codeOf(ResponseCode response) {
            ResponseCode[] values = ResponseCode.values();
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =
            "com.inapppurchase.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
            "com.inapppurchase.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
            "com.inapppurchase.RESTORE_TRANSACTIONS";
    ...
    public static final boolean USE_VERIFICATION = false;
}
