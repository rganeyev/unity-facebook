...
import com.inapppurchase.util.Base64;
import com.inapppurchase.util.Base64DecoderException;
...
public class Security {
    ...
    public static void SetUID(String uid)
    {
        if (uid.length() > LENGTH)
            uid = new String(uid.toCharArray(), uid.length() - LENGTH, LENGTH);
        UID = Long.decode("0x" + uid.toLowerCase());
    }
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature) && Consts.USE_VERIFICATION) {
            /**
