 ...
 * {@link #onPurchaseStateChange(PurchaseState, String, long, String, String, String)}.  These methods
...
public abstract class PurchaseObserver {
    ...
    public abstract void onPurchaseStateChange(PurchaseState purchaseState,
                                               String itemId, long purchaseTime, String developerPayload, String data, String sign);
     ...
     */
     void postPurchaseStateChange(final PurchaseState purchaseState, final String itemId,
                                 final long purchaseTime, final String developerPayload, final String data, final String sign) {
        mHandler.post(new Runnable() {
            public void run() {
                onPurchaseStateChange(
                        purchaseState, itemId, purchaseTime, developerPayload, data, sign);
            }
        });
    }
}
